...
Locates a feature along a line by using measures (eg. timestamp) stored in an additional property ("dimension") of the coordinates of the line. The "dimension" must follow Mapbox's `geojson-coordinateProperties` proposal (https://github.com/mapbox/geojson-coordinate-properties).
