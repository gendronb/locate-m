...
Locates a feature along a line by using measures (eg. timestamp) stored in an additional coordinates property ("dimension") of the line. The "dimension" must follow Mapbox's `geojson-coordinateProperties` proposal (https://github.com/mapbox/geojson-coordinate-properties).
